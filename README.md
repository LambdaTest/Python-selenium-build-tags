# Run Python Selenium Tests With Build Tags on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Python Selenium Tests With Build Tags across real browsers and operating systems.
