# Run Python Selenium Build Tags Tests on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Python Selenium Build Tags Tests across real browsers and operating systems.
